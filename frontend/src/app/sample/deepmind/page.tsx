...
const PAGES = [
  ...
  { type: "img", image_url: "/sample-manga-deepmind/pub-plotting.png", caption: "The King's Cross pub where DeepMind was conceived. Demis Hassabis and Shane Legg sketching their plan on napkins. <em>The world had no idea what was coming.</em>" },
  { type: "img", image_url: "/sample-manga-deepmind/childhood.png", caption: "Demis Hassabis at 13: chess prodigy, game developer, Cambridge scholar. A mind that could hold entire systems at once. <em>Already preparing for something bigger than chess.</em>" },
  { type: "img", image_url: "/sample-manga-deepmind/asilomar-hotel.png", caption: "Asilomar Conference, 1975 — the blueprint. Scientists pausing DNA research to ask: should we? Demis read everything about it. Safety wasn't an afterthought. <em>It was the founding principle.</em>" },
  ...
  { type: "img", image_url: "/sample-manga-deepmind/hoffman-billion.png", caption: "The boardroom. The handshake. The cheque. Reid Hoffman brokered the deal. Larry Page signed. Demis Hassabis became the most well-funded AI researcher alive. <em>And the most constrained.</em>" },
  { type: "img", image_url: "/sample-manga-deepmind/idealist-realist.png", caption: "The transformation begins. Idealism meets corporate reality. Research timelines meet product deadlines. The safety board never meets. The clause sits in a drawer." },
  { type: "img", image_url: "/sample-manga-deepmind/altman-betrayal.png", caption: "OpenAI launches. The race begins. Safety as competitive disadvantage. Demis watches from Google DeepMind as the rules he believed in get rewritten in public — by people who used to share his values.", bubble: "\"Speed is the new safety.\"" },
  ...
  { type: "img", image_url: "/sample-manga-deepmind/war-room.png", caption: "The war room. Every major AI lab racing. DeepMind's safety-first culture now a liability in the press, a punchline in Silicon Valley. <em>The idealist is now a realist. The question is: what does he do with that?</em>" },
  { type: "img", image_url: "/sample-manga-deepmind/two-paths.png", caption: "Two paths. Stay and fight from inside. Or leave and build the thing you actually believe in. Mustafa Suleyman already chose. Now it's Demis's turn." },
